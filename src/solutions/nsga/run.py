...
def recall_min():
    ...
    Mirrors gridsearch.recall_min but uses Optuna-NSGAII instead of exhaustive grid.
    """
...
def qps_min():
    ...
    Mirrors gridsearch.qps_min but uses Optuna-NSGAII instead of exhaustive grid.
    """
