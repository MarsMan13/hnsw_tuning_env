...
from main.solutions.brute_force.run import run as brute_force
from main.solutions.random_search.run import run as random_search
from main.solutions.our_solution.run5 import run as our_solution
from main.solutions.vd_tuner.run import run as vd_tuner
